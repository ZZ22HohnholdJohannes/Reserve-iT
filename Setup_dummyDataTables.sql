...
ALTER TABLE anschrift MODIFY anschrift_ID INT AUTO_INCREMENT;
ALTER TABLE gast MODIFY gast_ID INT AUTO_INCREMENT;
ALTER TABLE hotel MODIFY hotel_ID INT AUTO_INCREMENT;
ALTER TABLE kategorie MODIFY kategorie_ID INT AUTO_INCREMENT;
ALTER TABLE art MODIFY art_ID INT AUTO_INCREMENT;
ALTER TABLE preis MODIFY preis_ID INT AUTO_INCREMENT;
ALTER TABLE hotelzimmer MODIFY hotelzimmer_ID INT AUTO_INCREMENT;
ALTER TABLE auftrag MODIFY auftrag_ID INT AUTO_INCREMENT;
ALTER TABLE buchung MODIFY buchung_ID INT AUTO_INCREMENT;
ALTER TABLE bewertung MODIFY bewertung_ID INT AUTO_INCREMENT;
